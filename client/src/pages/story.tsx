    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[80vh] bg-gray-900 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white space-y-6">
          <span className="uppercase tracking-[0.3em] text-sm font-sans font-medium text-accent drop-shadow-md">Est. 1975</span>
      ...
      {/* The Beginning - Nisbet Oyster Company */}
      <section id="nisbet" className="py-20 md:py-32">
      ...
      {/* The Next Generation - Goose Point Farm */}
      <section id="farm" className="py-20 md:py-32 bg-secondary/30">
        <div className="container mx-auto px-4">
      ...
      {/* Values Grid - includes Hawaiian Shellfish Hatchery */}
      <section id="hatchery" className="py-24 bg-secondary text-foreground">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="font-sans text-2xl md:text-3xl font-medium">Stewards of the Bay</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="space-y-4 text-center p-6 border border-border bg-white/60 rounded hover:bg-white transition-colors shadow-sm">
              <div className="mx-auto w-12 h-12 bg-white flex items-center justify-center rounded-full mb-4 shadow-sm">
                <ShieldCheck className="w-6 h-6 text-accent" />
              </div>
              <h3 className="font-sans text-lg font-medium">Safety First</h3>
            ...
            <div className="space-y-4 text-center p-6 border border-border bg-white/60 rounded hover:bg-white transition-colors shadow-sm">
              ...
              <h3 className="font-sans text-lg font-medium">Sustainable Future</h3>
              <p className="text-muted-foreground text-sm leading-relaxed font-serif">
            ...
            <div className="space-y-4 text-center p-6 border border-border bg-white/60 rounded hover:bg-white transition-colors shadow-sm">
              ...
              <h3 className="font-sans text-lg font-medium">Community Core</h3>
              <p className="text-muted-foreground text-sm leading-relaxed font-serif">
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 max-w-4xl text-center space-y-8">
          ...
          <blockquote className="font-serif text-3xl md:text-5xl leading-tight text-foreground italic">
      ...
      <section className="relative py-24">
        ...
        <div className="relative container mx-auto px-4 text-center space-y-8">
          <h2 className="font-sans text-3xl md:text-4xl text-white font-medium">Taste the Tradition</h2>
          ...
          <Link href="/shop">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white px-8 py-6 text-lg rounded font-sans">
              Shop Our Oysters
            </Button>
          </Link>
        </div>
